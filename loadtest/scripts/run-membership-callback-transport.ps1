[CmdletBinding()]
param([ValidateSet('loadtest-realtime')][string]$Mode='loadtest-realtime',[int]$Threads=15,[string]$HostName='localhost',[int]$Port=6655,[string]$Protocol='http',[string]$OrderId='', [string]$Money='', [switch]$Cleanup)
