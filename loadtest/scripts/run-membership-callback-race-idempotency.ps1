[CmdletBinding()]
param([ValidateSet('loadtest-realtime')][string]$Mode='loadtest-realtime',[int]$Threads=8,[string]$HostName='localhost',[int]$Port=8080,[string]$Protocol='http',[string]$OrderId='', [string]$Money='', [switch]$Cleanup)
