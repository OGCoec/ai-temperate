...
/**
 * 该无状态适配器是来生成 Google 厂商的 8317 Chat Completions 请求，并按请求模式过滤其不支持的可选字段。
 */
@Component
public final class GoogleApiChatProviderAdapter implements ApiChatProviderAdapter {
    ...
    public GoogleApiChatProviderAdapter(ApiChatPayloadFactory payloadFactory) {
