...
/**
 * 将短信验证码登录请求委派给统一验证码流程服务的策略实现。
 */
@Component("smsCodeLoginStrategy")
public final class SmsCodeLoginStrategy implements LoginStrategy {

    private final LoginCodeFlowService flowService;

    public SmsCodeLoginStrategy(LoginCodeFlowService flowService) {
        this.flowService = flowService;
    }

    @Override
    public LoginStrategyType type() {
        return LoginStrategyType.SMS_CODE;
    }
