...
test('every current ordinary frontend API contract is admitted by an exact edge policy', () => {
	...
	const contracts = [
		...
		['POST', '/api/_edge/webrtc/verdict-status'],
		['GET', '/api/auth/csrf'],
		...
		['GET', '/api/auth/oauth2/authorization/github'],
		['GET', '/api/auth/oauth2/code/google'],
		['GET', '/api/auth/oauth2/code/github'],
		['POST', '/api/auth/oauth2/google/native/complete'],
		['GET', '/api/auth/oauth2/flow/status'],
		['POST', '/api/auth/oauth2/webrtc/resume'],
