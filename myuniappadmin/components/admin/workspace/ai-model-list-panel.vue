<template>
	<view class="workspace-panel">
		...
		<template #actions>
			...
			<admin-action-button tone="teal" :disabled="writing" @click="openDiscovery">
				发现模型
			</admin-action-button>
...
export default {
	...
	methods: {
		...
		openCreate() {
			this.$emit('request-navigation', { view: 'ai-model-create' })
		},
		openDiscovery() {
			this.$emit('request-navigation', { view: 'ai-model-discovery' })
		},
		openDetail(publicId) {
