...
export default {
	...
	data() {
		const form = this.discoveryPrefill
			? createDiscoveredAiModelForm(this.discoveryPrefill)
			: createEmptyAiModelForm()
		return {
			form,
