<template><view class="legacy-workspace-entry" aria-live="polite">正在打开 OpenAI 邮件检查…</view></template>
<script>
import { redirectLegacyAdminWorkspace } from '@/common/admin/admin-workspace-legacy-entry.js'
export default { onLoad() { redirectLegacyAdminWorkspace('/pages/mail-inspection/openai/index') } }
</script>
