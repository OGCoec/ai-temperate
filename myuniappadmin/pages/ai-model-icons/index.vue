<template><view class="legacy-workspace-entry" aria-live="polite">正在打开图标资源…</view></template>
<script>
import { redirectLegacyAdminWorkspace } from '@/common/admin/admin-workspace-legacy-entry.js'
export default { onLoad() { redirectLegacyAdminWorkspace('/pages/ai-model-icons/index') } }
</script>
