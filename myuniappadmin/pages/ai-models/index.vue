<template><view class="legacy-workspace-entry" aria-live="polite">正在打开模型目录…</view></template>
<script>
import { redirectLegacyAdminWorkspace } from '@/common/admin/admin-workspace-legacy-entry.js'
export default { onLoad() { redirectLegacyAdminWorkspace('/pages/ai-models/index') } }
</script>
