...
test('ordinary risk challenge uses the shared three-round state machine and a recoverable failure gate', () => {
	...
	const gate = source('common/shared-auth/risk-challenge-failed-gate.vue')
	const core = source('common/shared-auth/risk-challenge-state-machine.js')
...
test('ordinary Android risk challenge bridges PreAuth through one bounded WebView retry', () => {
	...
	const preAuth = source('common/auth/pre-auth.js')
	const http = source('common/auth/http-client.js')
	const shared = source('common/shared-auth/android-risk-challenge.js')
...
test('H5 and Android WebRTC verification use isolated platform probes and never persist IPs', () => {
	...
	const core = source('common/shared-auth/webrtc-verification-core.js')
	const h5Probe = source('common/shared-auth/h5-webrtc-probe.js')
	const http = source('common/auth/http-client.js')
	const authApi = source('common/auth/auth-api.js')
	const androidProbe = source('common/shared-auth/android-webrtc-background-probe.js')
	const diagnostics = source('common/shared-auth/webrtc-diagnostics.js')
