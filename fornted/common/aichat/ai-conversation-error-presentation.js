const AI_CONVERSATION_ERROR_MESSAGES = Object.freeze({
	...
	AI_MODEL_REASONING_LEVEL_UNSUPPORTED: '当前模型不支持所选推理档位。',
	AI_IMAGE_RESOLUTION_UNSUPPORTED: '当前模型不支持所选图片分辨率。',
	AI_PROVIDER_TOOL_UNSUPPORTED: '当前模型不支持所选联网搜索配置。'
})
...
const AI_CONVERSATION_STREAM_REASON_MESSAGES = Object.freeze({
	...
	UPSTREAM_REASONING_LEVEL_UNSUPPORTED: '当前模型不支持所选推理档位',
	UPSTREAM_IMAGE_RESOLUTION_UNSUPPORTED: '当前模型不支持所选图片分辨率',
	UPSTREAM_TOOL_CONFIGURATION_UNSUPPORTED: '当前模型不支持所选工具配置',
